...
// Identifies static-range PTQ pre-calibration step. Used for debugging
// purposes, like as the prefix for the MLIR dump file.
constexpr absl::string_view kStaticRangePtqPreCalibrationStepName =
    "static_range_ptq_pre_calibration";

// Identifies static-range PTQ post-calibration step. Used for debugging
// purposes, like as the prefix for the MLIR dump file.
constexpr absl::string_view kStaticRangePtqPostCalibrationStepName =
    "static_range_ptq_post_calibration";
...
absl::StatusOr<ExportedModel> QuantizePtqModelPreCalibration(
  ...
  TF_RETURN_IF_ERROR(PreprocessAndFreezeGraph(
      /*mlir_dump_file_prefix=*/kStaticRangePtqPreCalibrationStepName,
  ...
  const ExportOptions export_opts = {
      ...
      /*debug_name=*/
      absl::StrCat(kStaticRangePtqPreCalibrationStepName, kExportStepSuffix)};
...
absl::StatusOr<ExportedModel> QuantizePtqModelPostCalibration(
  ...
  TF_RETURN_IF_ERROR(PreprocessAndFreezeGraph(
      /*mlir_dump_file_prefix=*/kStaticRangePtqPostCalibrationStepName,
  ...
  TF_RETURN_IF_ERROR(RunPasses(
      kStaticRangePtqPostCalibrationStepName, /*add_passes_func=*/
      [](PassManager& pm) {
  ...
  const ExportOptions export_opts = {
      ...
      /*unfreeze_constants=*/false, checkpoint_dir,
      /*debug_name=*/
      absl::StrCat(kStaticRangePtqPostCalibrationStepName, kExportStepSuffix)};
...
absl::Status QuantizeStaticRangePtq(
  ...
  py_function_library.RunCalibration(
      *precalibrated_saved_model_dir, signature_keys, tags,
      ...
      /*force_graph_mode_calibration=*/true, representative_dataset);
